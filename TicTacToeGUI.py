...
def Play_game(button_num):
    ...
    while rool <= 1:
        ...
        if check_if_win or check_if_tie == True:
            break
        error_text = tk.Label(root, height=1, width=10, bg="grey", text="", font=("", 25))
...
while check_if_win == False or check_if_tie == False:
    canvas = tk.Canvas(height=600, width=600, bg="#263D42")
    frame = tk.Frame(root, bg="white")
    frame.place(relwidth=0.8, relheight=0.8, relx=0.1, rely=0.104)

    error_text = tk.Label(root, height=1, width=10, bg="grey", text="", font=("", 25))
    error_text.place(relx=0.36, rely=0.028)

    button1 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_0())
    button1.place(relx=0.1, rely=0.11)

    button2 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_1())
    button2.place(relx=0.375, rely=0.11)

    button3 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_2())
    button3.place(relx=0.645, rely=0.11)

    button4 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_3())
    button4.place(relx=0.1, rely=0.38)

    button5 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_4())
    button5.place(relx=0.375, rely=0.38)

    button6 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_5())
    button6.place(relx=0.645, rely=0.38)

    button7 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_6())
    button7.place(relx=0.1, rely=0.655)

    button8 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_7())
    button8.place(relx=0.375, rely=0.655)

    button9 = tk.Button(root, height=3, width=6, bg="blue", text="", font=("", 40), command=lambda: button_8())
